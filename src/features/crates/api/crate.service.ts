...
import type { ApiResponse, PaginatedResult } from "@/features/auth/auth.types";

import type { Crate, CrateDetails, CreateCrateRequest, GetCrateParams, UpdateCrateRequest } from "../crate.types";
