...
import CratesPageHeader from "./CratesPageHeader";

type CratesErrorStateProps = {
  error: Error | unknown;
};

function CratesError({ error }: CratesErrorStateProps) {
  return (
    <div className="space-y-6 p-6">
      ...
      <div className="rounded-md bg-card p-4 border border-accent">
        <div className="flex">
          ...
          <div className="ml-3">
            <h3 className="text-sm font-medium text-red-300">Failed to load crates</h3>
