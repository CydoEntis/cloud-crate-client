...
import FolderFilterControls from "./FolderFilterControls";
...
const FolderFilters: React.FC<FolderFiltersProps> = ({ filterControls }) => {
  ...
  return (
    <div className="space-y-4">
          ...
          <Drawer open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DrawerContent className="p-6 border-muted">
              <DrawerHeader className="p-0 mb-0">
                <DrawerTitle className="text-left">Sort Files & Folders</DrawerTitle>
              </DrawerHeader>
              <DrawerDescription>Choose how to sort your files and folders.</DrawerDescription>

              <div className="mt-6 space-y-4">
                <FolderFilterControls filterControls={filterControls} isMobile onMobileClose={handleMobileClose} />
              </div>
            </DrawerContent>
          </Drawer>
        </div>
      ...
      <div className="hidden md:flex md:items-end md:justify-between md:gap-4">
        <FolderFilterControls filterControls={filterControls} />
      </div>
    </div>
  );
};
